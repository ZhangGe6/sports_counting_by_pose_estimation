...
Below pngs are the running samples of these two sports (using Hisilicon 990). The counting number are shown on the upper left. you can see the mp4 format in the folder `samples`. And you can also download the [apk](https://github.com/ZhangGe6/sports_counting_by_pose_estimation/raw/master//app-debug.apk) to test on your device.
